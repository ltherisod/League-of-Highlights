        ...
        <div className="news" >
            <div className="socialContent">
                ...
                <div className="socialBox">
                    <a className="socialMediaHover" href="https://www.youtube.com/user/riotgamesinc" target="_blank" rel="noreferrer">
                        <img className="socialMediaIcon" src="./assets/youtube.png" alt=""/>
                    </a>
                    <a className="socialMediaHover" href="https://twitter.com/leagueoflegends" target="_blank" rel="noreferrer">
                        <img className="socialMediaIcon" src="./assets/twitter.png" alt=""/>
                    </a>
                    <a className="socialMediaHover" href="https://www.facebook.com/leagueoflegends" target="_blank" rel="noreferrer">
                        <img className="socialMediaIcon" src="./assets/facebook.png" alt=""/>
                    </a>
                    <a className="socialMediaHover" href="https://www.instagram.com/leagueoflegends/" target="_blank" rel="noreferrer">
                        <img className="socialMediaIcon" src="./assets/instagram.png" alt=""/>
                    </a> 
                    <a className="socialMediaHover" href="https://www.reddit.com/r/leagueoflegends/" target="_blank" rel="noreferrer">
