...
const CallToAction = () => {
    return (
        <div className="mainCallToAction" style={{backgroundImage: "url('https://i.postimg.cc/vmmZW0Cc/nubescall.png')"}}>
            <ReactPlayer width="600px" height="400px" url='https://www.youtube.com/watch?v=SQjxq7r4R1s' className="videoCallToAction" playing={true} loop={true} volume={0} muted={true} controls={false}/>
